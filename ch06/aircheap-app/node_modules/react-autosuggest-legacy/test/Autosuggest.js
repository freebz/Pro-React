...
const Autosuggest = proxyquire('../src/Autosuggest', { debounce: fn => fn }).default;
  ...
  describe('suggestionRenderer', () => {
    describe('with string suggestions', () => {
      ...
      it('should use the specified suggestionRenderer function', () => {
        suggestions = TestUtils.scryRenderedDOMComponentsWithClass(autosuggest, 'react-autosuggest__suggestion');
        expect(stripReactAttributes(suggestions[0].innerHTML)).to.equal('<span><strong>M</strong><!-- react-text: 7 -->ill Park<!-- /react-text --></span>');
      });
    });
    ...
    describe('with object suggestions', () => {
      ...
      it('should use the specified suggestionRenderer function', () => {
        suggestions = TestUtils.scryRenderedDOMComponentsWithClass(autosuggest, 'react-autosuggest__suggestion');
        expect(stripReactAttributes(suggestions[0].innerHTML)).to.equal('<span><strong>M</strong><!-- react-text: 7 -->ill Park<!-- /react-text --><!-- react-text: 8 --> VIC <!-- /react-text --><!-- react-text: 9 -->3083<!-- /react-text --></span>');
      });
    });
  });
