// 예제 7-9. Card 컴포넌트의 shouldComponentUpdate 구현
...
class Card extends Component {
	...
	return connectDropTarget(connectDragSource(
		...
		<div className={
		    this.props.showDetails !== false? "card__title card__title--is-open" : "card__title"} onClick={this.toggleDetails.bind(this)}>
